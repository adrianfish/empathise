...
const mainUsage = commandLineUsage([
  {
    content: `Empathise manipulates JavaScript module specifiers in NPM packages.`
  },
  {
    header: 'Commands',
    content: [
      ...
      {
        name: 'help',
        summary: 'Display help information about empathise or its subcommands'
      }
    ]
  }
]);
...
const installUsage = commandLineUsage([
  ...
  {
    header: 'Usage',
    content: '$ empathise install [-a <directory>] [-o <packages>] [-i <packages>] [-e] [-q <cache busting query>]'
  },
...
const publishUsage = commandLineUsage([
  ...
  {
    header: 'Usage',
    content: '$ empathise publish -s <source globs> [-a <directory>] [-d <directory>]'
  },
